...
/**
 * REST controller for managing {@link com.thg.procurement.questionnaire.service.domain.Answer}.
 */
@RestController
@RequestMapping("/api")
public class AnswerResource {
    ...
    private static final String ENTITY_NAME = "questionnaireServiceAnswer";
    ...
    public ResponseEntity<Answer> updateAnswer(
        ...
        return ResponseEntity
            .ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, answer.getId()))
            .body(result);
    }
    ...
    public ResponseEntity<Answer> partialUpdateAnswer(
        ...
        Optional<Answer> result = answerRepository
            ...
            .map(existingAnswer -> {
                if (answer.getQuestionnaireId() != null) {
                    existingAnswer.setQuestionnaireId(answer.getQuestionnaireId());
                }
                if (answer.getIsDeleted() != null) {
                    existingAnswer.setIsDeleted(answer.getIsDeleted());
                }
                if (answer.getCreatedBy() != null) {
                    existingAnswer.setCreatedBy(answer.getCreatedBy());
                }
                if (answer.getCreatedAt() != null) {
                    existingAnswer.setCreatedAt(answer.getCreatedAt());
                }
                if (answer.getUpdatedBy() != null) {
                    existingAnswer.setUpdatedBy(answer.getUpdatedBy());
                }
                if (answer.getUpdatedAt() != null) {
                    existingAnswer.setUpdatedAt(answer.getUpdatedAt());
                }
                if (answer.getData() != null) {
                    existingAnswer.setData(answer.getData());
                }
                if (answer.getClient() != null) {
                    existingAnswer.setClient(answer.getClient());
                }
        ...
        return ResponseUtil.wrapOrNotFound(result, HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, answer.getId()));
    }
