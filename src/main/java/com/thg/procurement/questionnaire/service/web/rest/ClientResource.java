...
/**
 * REST controller for managing {@link com.thg.procurement.questionnaire.service.domain.Client}.
 */
@RestController
@RequestMapping("/api")
public class ClientResource {
    ...
    private static final String ENTITY_NAME = "questionnaireServiceClient";
        ...
        Optional<Client> result = clientRepository
            ...
            .map(existingClient -> {
                ...
                if (client.getIsDeleted() != null) {
                    existingClient.setIsDeleted(client.getIsDeleted());
                }
